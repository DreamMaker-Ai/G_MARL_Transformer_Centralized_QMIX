...
class Config:
    def __init__(self):
        ...
        self.model_dir = 'models/model_10200/'
        self.global_model_dir = 'models/global_model_10200/'
        # self.model_dir = None
        # self.global_model_dir = None

        if self.model_dir:  # starting steps for continual training
            self.n0 = 10200  # learner update cycles. Should be read from tensorboard
            self.actor_cycles = 74357  # Should be read from tensorboard
        else:
            self.n0 = 0
            self.actor_cycles = 0
        ...
        self.draw_win_distributions = True  # mainly for debug
        ...
        # self.hyper_mixing_n_frames = 2
        # self.hyper_mixing_obs_channels = 4

        # Training parameters
        self.actor_rollout_steps = 100  # default=100
        self.num_update_cycles = 1000000
        self.actor_rollouts_before_train = 20  # default=50 -> 20
        self.batch_size = 128  # Default=128 for fine-tuning
        self.num_minibatchs = 5  # default=5 for fine-tuning
        ...
        self.max_num_red_agents = 20  # Have to be the same to pre-training
