...
class Config:
    def __init__(self):
        ...
        # self.model_dir = 'models/model_12300/'  # newest file -> 'ls -ltr'
        # self.global_model_dir = 'models/global_model_12300/'
        self.model_dir = None
        self.global_model_dir = None

        if self.model_dir:  # starting steps for continual training
            self.n0 = 12400  # learner update cycles. Should be read from tensorboard
            self.actor_cycles = 188630  # Should be read from tensorboard
        else:
            self.n0 = 0
            self.actor_cycles = 0
